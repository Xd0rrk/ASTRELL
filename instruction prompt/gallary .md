Create a **new, independent page** called **Gallery**. This is **not** the existing Gallery section on the landing page. The landing page Gallery should remain unchanged. Instead, create a completely separate Gallery page that users can access through the navigation bar.

Update the navigation bar by adding a new **Gallery** tab that navigates to this new page. Also, remove the **"Europe and Me"** navigation item from the navigation bar.

The new Gallery page must match the existing website's design system exactly, including the same color palette, typography, spacing, animations, and overall visual style.

This page should showcase our previous work, including posters, banners, branding, social media designs, marketing materials, and other creative projects. The gallery should be highly visual, with the work itself as the main focus.

I will provide the code for an **infinite scrolling gallery**, and you **must use that exact implementation**. Do not replace it with another gallery or use it only as inspiration. Integrate it into the new Gallery page while styling it to match the rest of the website. Ensure it is fully responsive, smooth, high-performance, and includes polished transitions and hover effects that fit the site's overall experience.

The final result should feel like a dedicated portfolio page that is seamlessly integrated into the website and accessible directly from the navigation bar.
